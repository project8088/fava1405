...
const routes: Routes = [
  {
    path: '', component: CompanyComponent, canActivateChild:[AuthGuard], children: [
      ...
      { path: 'citizen-excel-files-details/:id', component: CompanyCitizenExcelBatchFileDetailsComponent },
