...
export class CompanyContactUsListComponent implements AfterViewInit {
 
  displayedColumns: string[] = ['row', 'name', 'email', 'mobileNumber', 'userName','companyName', 'subject','view'];
    ...
    merge()
      .pipe(
        ...
        switchMap(() => {
          ...
          return this.dataService.get(ServerApis.getComapnyContactList, param);
        }),
        map(response => {
