...
export class AdminAddOrUpdateNotificationComponent implements OnInit, AfterViewInit {
  isUpdate: boolean;
 ...
 loading: boolean;
  ...
  getNotificationInfo() {
    this.loading = true;
    this.dataService.get(ServerApis.getNotification, {
      ...
      if (response.isSuccess && response.data) {
        ...
        this.notyForm.setValue({
          ...
          notificationNumber: response.data.notificationNumber ? response.data.notificationNumber:''
        });
...
*/
  ...
  save() {
    ...
    this.isSaving = true;
    this.dataService.post(ServerApis.addOrUpdateNotifications, params).subscribe(response => {
      this.isSaving = false;
