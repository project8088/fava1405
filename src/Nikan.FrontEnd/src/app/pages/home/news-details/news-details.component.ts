...
export class MainNewsDetailsComponent extends AppBase implements OnInit {
  ...
  getComments() {
    ...
    this.dataService
      .get(ServerApis.getNewsPublishComments, { id: this.newsId })
      .pipe(
        finalize(() => {
  ...
  sendComment() {
    ...
    this.dataService
      .post(ServerApis.addNewsComments, param)
      .pipe(
        finalize(() => {
  ...
  getLastNews() {
    ...
    this.dataService
      .get(ServerApis.getLastNews, { top: 10 })
      .pipe(
        finalize(() => {
  ...
  getMostVisitedNews() {
    ...
    this.dataService
      .get(ServerApis.getMostVisitedNews, { top: 10 })
      .pipe(
        finalize(() => {
