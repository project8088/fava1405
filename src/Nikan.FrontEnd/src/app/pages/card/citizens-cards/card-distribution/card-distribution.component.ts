...
export class CardCarddistributionComponent implements AfterViewInit {
        ...
        map((response) => {
          ...
          if (response.isSuccess && response.data) {
            ...
            if (param.autopost == true) {
              this.sendCardToQueue(response.data.citizenCardInfoId, response.data.citizenId, response.data.deliverType, response.data.cardTypeId, response.data.deliveringCenterId);
            }
  ...
  getQueueListInCourse() {
    ...
    this.dataService.get(ServerApis.getQueueListInCourse, { courseId: this.courseId }).subscribe(response => {
  ...
  delete(cardId) {
    this.dataService.get(ServerApis.removeCardFromQueueByCourseId, { courseId: this.courseId , cardId: cardId }).subscribe(response => {
      if (response.isSuccess) {
