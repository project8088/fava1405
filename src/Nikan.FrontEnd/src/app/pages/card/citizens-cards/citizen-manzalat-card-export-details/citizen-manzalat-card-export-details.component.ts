...
export class CardManzalatCitizenCardExportDetailsComponent extends AppBase implements AfterViewInit {
      ...
      .pipe(
        ...
        switchMap(() => {
          ...
          return this.dataService.get(
            ServerApis.getPagedManzalatCardInfoExportDetailsForSend,
            param,
          );
        }),
        map((response) => {
