...
export class TicketListComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    if (this.currentUser.isAdmin)
      this.displayedColumns = ['row', 'code', 'organName', 'fullName', 'subject', 'priority', 'organizationalUnit', 'createdOn', 'ticketStatus', 'operation'];
    else
      this.displayedColumns = ['row', 'code', 'fullName', 'subject', 'priority', 'organizationalUnit', 'createdOn', 'ticketStatus', 'operation'];
  }
  ...
  getList() {
    ...
    if (this.currentUser.isAdmin)
      ticketUrl = ServerApis.getAdminTicketsList;
    else if (this.currentUser.isCompany)
      ticketUrl = ServerApis.getCompanyTicketsList;
    else if (this.currentUser.isCardUser)
      ticketUrl = ServerApis.getCardTicketsList;
  ...
  openNewTicketDialog() {
    this.matDialog.open(SendTicketDialogComponent, {
