...
export class InputRefundUsersAutoCompleteComponent implements ControlValueAccessor, OnInit {
...
//this.ngControl = new FormControl(null, [RequireMatch]);
  ...
  getCompanyList() {
    ...
    this.loading = true;
    this.dataService.get(ServerApis.getAllRefunAccessUsers, {}).subscribe(response => {
      this.loading = false;
