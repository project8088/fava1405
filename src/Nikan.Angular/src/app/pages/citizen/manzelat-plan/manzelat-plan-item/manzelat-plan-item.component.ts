...
export class CitizenManzelatPlanItemComponent implements OnInit {
  ...
  ngOnInit(): void {}
    ...
    getCardInfo() {
        this.dataService.get(ServerApis.getCitizenManzalat, { formBaseId: this.id })
      .subscribe((data) => {
        this.loading = false;
        ...
        this.theForm.patchValue({
          ...
          chk_Janbazan_JesmiHarekati_NoWheelChair:   data.data.chk_Janbazan_JesmiHarekati_NoWheelChair,
          typ_Janbazan_JesmiHarekati_NoWheelChair:  data.data.typ_Janbazan_JesmiHarekati_NoWheelChair,
          ...
          //معلولین
            ...
            chk_Maloulin_JesmiHarekati_NoWheelChair:  data.data.chk_Maloulin_JesmiHarekati_NoWheelChair,
            typ_Maloulin_JesmiHarekati_NoWheelChair:  data.data.typ_Maloulin_JesmiHarekati_NoWheelChair,
