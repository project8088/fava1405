...
export class  CardDiscountListComponent implements OnInit, AfterViewInit {
  loading: boolean;
  displayedColumns: string[] = ['row', 'discountTitle', 'cardType', 'creationDate','discountIsActive', 'byUser', 'discountPercent', 'postalPercentInCity', 'startDate', 'endDate', 'operation'];
  ...
  openDialog(item) {
    this.matDialog.open(CardAddCardDiscountDialogComponent, {
