...
export class AdminRegisterCompanyComponent implements OnInit {
  ...
  constructor(
    ...
    this.registerForm = this.fb.group({
      ...
      englishName: [null, [Validators.required, Validators.maxLength(40), this.customValidator.checkEnglishCharacters]],
      companyRepresentative: [null, [Validators.required, Validators.maxLength(100), this.customValidator.checkPersianCharacters]],
  ...
  getCaptcha() {
    ...
    this.dataService.getCaptchaImage({}).subscribe(response => {
  ...
  saveInfo() {
    ...
    this.isSaving = true;
    this.dataService.post(ServerApis.companyRegisterAsync,
      {
