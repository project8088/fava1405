...
export class AdminContactUsListComponent implements AfterViewInit {
 
  displayedColumns: string[] = ['row', 'name', 'email', 'mobileNumber', 'userName','companyName', 'subject', 'message', 'organizationalUnit'];
