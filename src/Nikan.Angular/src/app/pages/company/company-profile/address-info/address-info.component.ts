...
export class CompanyAddressInfoComponent implements OnInit {
  ...
  constructor(
    ...
    this.addressForm = this.fb.group({
      ...
      website: [null, [Validators.maxLength(100), this.customValidators.checkEnglishAndNumberCharacters]],
      email: [null, [Validators.required, Validators.maxLength(100), this.customValidators.checkEmail]],
  ...
  getAddressInfo() {
    this.loading = true;
    this.dataService.get(ServerApis.getCompanyAddressInfo, {
  ...
  save() {
    ...
    this.dataService.post(ServerApis.updateCompanyAddressInfo, dataToPost).subscribe(response => {
      this.isSaving = false;
