...
import { ServerApis } from '../../../core/server-apis';
 ...
 export class CompanyCitizenExcelBatchFileDetailsComponent implements AfterViewInit {
  loading: boolean;
   displayedColumns: string[] = ['row', 'gender',  'nationCode',
     'firstName', 'lastName', 'fatherName', 'birthDate', 'mobile', 'jobTitle', 'address'];
  ...
  getList() {
    ...
    this.data = [];
    this.dataService.get(ServerApis.personnelImportFileDetails, { importId: this.importId}).subscribe(response => {
  ...
  confirm() {
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.dataService.get(ServerApis.confirmCitizenFile, {
