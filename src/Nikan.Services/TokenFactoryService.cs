...
namespace Nikan.Services
{
    ...
    public class TokenFactoryService : ITokenFactoryService
    {
        ...
        {
            UserCompanyAccountStatusEnum state = UserCompanyAccountStatusEnum.تایید_شده;
            int  stateId = 1;
            var companyId = user.UserCompanyId == null ? 0 : user.UserCompanyId.Value;
            var rejectDesription = "";
            if (user.UserCompany!=null)
            {
                state = user.UserCompany.UserCompanyAccountStatus;
                stateId =(int) user.UserCompany.UserCompanyAccountStatus;
                rejectDesription = user.UserCompany.RejectDesription==null ? "" : user.UserCompany.RejectDesription;
            ...
            var claims = new List<Claim>
            {
                ...
                new Claim("UserCompanyId",companyId.ToString(), ClaimValueTypes.String, _configuration.Value.Issuer),
                new Claim("UserCompanyAccountStatus",state.ToString(), ClaimValueTypes.String, _configuration.Value.Issuer),
                new Claim("rejectDesription",rejectDesription.ToString(), ClaimValueTypes.String, _configuration.Value.Issuer),
                new Claim("UserCompanyAccountStatusId",stateId.ToString(), ClaimValueTypes.String, _configuration.Value.Issuer),
